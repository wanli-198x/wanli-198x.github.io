import { Ref } from 'vue';
declare const focusReason: Ref<"pointer" | "keyboard" | undefined, "pointer" | "keyboard" | undefined>;
declare const lastUserFocusTimestamp: Ref<number, number>;
declare const lastAutomatedFocusTimestamp: Ref<number, number>;
